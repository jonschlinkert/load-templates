...
utils.flattenOptions = function flattenOptions(obj) {
  ...
  opts = utils.omitRoot(opts);
  return utils.omitOptions(opts, 'options');
};
 ...
 * @return {Object}
 */
utils.flatten = function flatten(prop, objects) {
  var args = [].slice.call(arguments, 1);
  var len = args.length;
  var o = {};
    ...
    forOwn(obj, function (value, key, obj) {
      if (key === prop) {
        ...
        if (hasOwn(value[prop], prop)) {
          copy(o, flatten(prop, value[prop]));
...
// utils.flattenProp = function flattenProp(prop, objects) {
//   var args = [].slice.call(arguments, 1);
...
//         if (isObject(obj[key])) {
//           o[prop] = flattenProp(prop, obj[key])
//         }
//       }
